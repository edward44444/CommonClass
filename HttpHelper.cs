...
namespace CommonClass
{
    public class HttpHelper
    {
        ...
        public string GetResponse(string uri, byte[] postData = null, CookieContainer cookieContainer = null)
        {
            ...
            return GetResponse(out headers, out cookies, uri, postData, cookieContainer);
        }

        public string GetResponse(out Dictionary<string, string> responseHeaders, out CookieCollection responseCookies, string uri, byte[] postData = null, CookieContainer cookieContainer = null)
        {
